 ...
 */
+ (IMP)replaceInstanceMethod:(SEL)selector inClass:(Class)cls withBlock:(dispatch_block_t)block;
 ...
 *  @return Implementation of the replaced instance method before swizzling
 */
+ (IMP)replaceInstanceMethod:(SEL)selector inClass:(Class)cls withImplementation:(IMP)implementation;
 ...
 */
+ (IMP)replaceClassMethod:(SEL)selector inClass:(Class)cls withBlock:(dispatch_block_t)block;
 ...
 *  @return Implementation of the replaced class method before swizzling
 */
+ (IMP)replaceClassMethod:(SEL)selector inClass:(Class)cls withImplementation:(IMP)implementation;
